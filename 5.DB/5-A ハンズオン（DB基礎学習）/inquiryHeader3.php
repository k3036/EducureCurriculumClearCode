...
<head>
  ...
  <title>inquiryHeader2.php</title>
  <link rel="stylesheet" href="form.css">
</head>

<body>
  <div class="headMenuSet">
    <div class="headMenu5">
      <a href="#"><img src="cafe\img\logo.png" alt="" width="210px" height="30px"></a>
    </div>
    <div class="topMenu3">
      <p class="example">
        <a href="" style=text-decoration:none; class="space">サインイン</a>
        <a href="" style=text-decoration:none; class="followSpace"></a>
      <div class="overlay"></div>
      <div class="modal">
        <p class="Login2">ログイン</p>
        <div class="modalLine3"> </div>
        <div class="mailAddress2"> <input class="sizeTextBox2" type=" text" placeholder="パスワード"></div>
        <div class="passWord2"> <input class="sizePassWord2" type=" text" placeholder="メールアドレス"></div>
    ...
    <div class="exampleE">
      <a href="contact.php" style=text-decoration:none;>始めに</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href=" contact.php " style=text-decoration:none;>体験</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
